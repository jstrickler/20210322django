"""
Django settings for bettertables project.
...
ROOT_URLCONF = 'bettertables.urls'
...
WSGI_APPLICATION = 'bettertables.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'bettertables.db'),
    }
}
